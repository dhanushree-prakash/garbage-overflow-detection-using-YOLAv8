Project Title: YOLOv8 Garbage Overflow Detection with Flask Web App 🗑️🤖
...
2. Executable/         -> Compiled executable files (if any) ⚙️
...
3. Upload an image or start live detection to see overflowing bins highlighted 🗑️✅
